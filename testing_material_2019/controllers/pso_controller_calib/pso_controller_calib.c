...
//TODO REPLACE MAX_SPEED_WEB par 2*PI
...
#define SPEED_UNIT_RADS 0.00126 // Conversion factor from speed unit to radian per second
...
int main(int argc, char *args[]){
    ...
    while(1){
        ...
        for(int k=0; k<rbuffer[DATASIZE]; k++) {
          ...
          // Set speed
          msl_w = msl*MAX_SPEED_WEB/MAX_SPEED;
          msr_w = msr*2*PI/MAX_SPEED;
