...
#define MAX_SPEED       1000/5.    // Maximum speed
#define MAX_SPEED_WEB   6.28/5.    // Maximum speed webots
...
#define DELTA           1.4     // Proportional constant for cohesion
#define ZETA            0.8     // Gain for cohesion non-linearity
#define IOTA            0.3     // Gain for proximal non-linearity
#define MIGRATION_BIAS  0.2     // Migration bias
...
void update_self_motion(int msl, int msr) {
    ...
    float dr = (float)msr * SPEED_UNIT_RADS * WHEEL_RADIUS * TIME_STEP/1000.; //ms
